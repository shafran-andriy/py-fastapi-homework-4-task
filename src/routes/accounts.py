...
ACCOUNT_ACTION_BASE_URL = "http://127.0.0.1/api/v1/accounts"


def build_account_action_url(action_path: str, **query_params: str) -> str:
    url = f"{ACCOUNT_ACTION_BASE_URL}/{action_path.strip('/')}/"
    if query_params:
...
async def register_user(
    ...
    try:
        ...
        activation_link = build_account_action_url(
            "activate",
            email=str(user_data.email),
...
async def activate_account(
    ...
    login_link = build_account_action_url("login")
    background_tasks.add_task(
...
async def request_password_reset_token(
    ...
    reset_link = build_account_action_url(
